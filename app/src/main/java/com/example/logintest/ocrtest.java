...
public class ocrtest extends AppCompatActivity {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                if(snapshot !=null&&snapshot.exists())
                {
                    if(snapshot.getChildren()!=null)
                    {
                        ...
                        //String finikiinfo = snapshot.child("finikiinfo").getValue(String.class);
                        //String finikilogo = snapshot.child ( "logo" ).getValue (String.class);
                        //String top1profile = snapshot.child ("finiki_top_01").child ( "profile" ).getValue (String.class);
                        //String top1name = snapshot.child ("finiki_top_01").child ( "name" ).getValue (String.class);
                      ...
                      //  String top_01_profile = snapshot.child( brandname2+"_top_01" ).child("profile").getValue (String.class);
                        ...
                        //logo.setImageResource ( feedlogo );
                        //  브랜드로고, 브랜드정보, 인기사료1~3의 프로필과 이름! 그건 제가 해볼게요 코드 대충앎
